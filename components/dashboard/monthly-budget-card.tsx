...
export function MonthlyBudgetCard({
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-br from-[#0F1115] to-[#2D2F36] dark:from-[#2D2F36] dark:to-[#0F1115] p-6 text-white shadow-theme-lg relative overflow-hidden">
